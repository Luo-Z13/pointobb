...
data_root_train = '../DOTAv10/data/split_ss_dota_1024_200/train_split1024_mini2/'
data_root_val = '../DOTAv10/data/split_ss_dota_1024_200/val_split1024_mini2/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root_train + "train_1024_mini2_hbox_pt.json",
    ...
    test=dict(
        ...
        ann_file=data_root_val + "val_coco_1024_mini2.json",
        pipeline=test_pipeline))
...
work_dir = '../TOV_mmdetection_cache/work_dir/P2B_dota/'
...
# # # TODO: for debug
# load_from = '../TOV_mmdetection_cache/work_dir/P2B_dota/epoch_10.pth'
# load_from='../TOV_mmdetection_cache/work_dir/P2B_dota/epoch_10.pth'
# load_from = '../TOV_mmdetection_cache/work_dir/P2B_dota/epoch_10.pth'
# evaluation = dict(
#     save_result_file='../TOV_mmdetection_cache/work_dir/P2B_dota/1024_latest_result.json',
#     do_first_eval=True
# )
